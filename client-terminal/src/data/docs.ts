					...
					sections: [
						{
							...
							items: [
								{
									number: "1",
									text: "Configure your .env file with desired AI provider",
								},
								{
									number: "2",
								...
								{
									number: "3",
									text: 'Use "otter api generate" to get an API key',
								},
								{
									number: "4",
									text: "Start chatting directly or with commands",
								},
							],
						},
						{
					...
					sections: [
						{
							...
							text: [
								...
								"",
								'1. Generate an API key using "otter api generate"',
