export const getLineColor = (line: string | null | undefined): string => {
	...
	if (line.includes("SUCCESS:")) return "text-[#F6BD7A]";
	if (line.includes("ACCESSING") || line.includes("Loading"))
	...
	if (line === "Download complete!") return "text-[#F6BD7A]";
