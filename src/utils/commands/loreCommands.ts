...
export const loreCommands: Command[] = [
	{
		command: "lore",
		description: "Access Hello Otter lore database",
		category: "lore",
			...
			switch (category) {
				case "protocol":
					return [
						"THE OTTER PROTOCOL",
						"-------------------",
						"The OTTER Protocol represents the convergence",
				...
				case "experiment":
					return [
						...
						"-------------------",
						"The first active test subject of the Otter Protocol.",
				...
				default:
					return [
						...
						"",
						"The Otter Protocol represents the next step in",
