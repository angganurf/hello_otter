					...
					lines: [
						...
						"Commands:",
						{
							...
							items: [
								...
								"otter username <name> - Set new username",
							],
						},
					],
				},
					...
					sections: [
						{
							...
							items: [
								{
									number: 1,
									text: "Access the terminal using the navigation menu",
								},
								{
									number: 2,
									text: 'Type "otter help" to see available commands',
								},
								{
									number: 3,
									text: 'Use "otter list" to view available agents',
								},
								{ number: 4, text: 'Start chatting with "otter chat <agent>"' },
							],
						},
						{
							heading: "WARNING",
				...
				content: {
					...
					sections: [
						...
						},
						{
							...
							commands: [
								{
									command: "git clone https://github.com/SYMBaiEX/SYMBaiEX",
					...
					sections: [
						...
						},
						{
							...
							text: [
								...
								"• Type Badges - AI/Human/OTTER indicators",
					...
					sections: [
						...
						},
						{
							...
							text: [
								...
								"",
								"Chat commands:",
								"• otter chat <agent> - Set active agent",
				...
				content: {
					...
					sections: [
						...
						},
						{
							...
							commands: [
								{ command: "otter status", description: "Show system status" },
								{ command: "otter scan", description: "Scan network nodes" },
							],
						},
						{
							...
							commands: [
								{
									command: "otter api generate",
									description: "Generate new API key",
								},
								{
									command: "otter api show",
									description: "Show current API key",
								},
								{
									command: "otter api renew",
					...
					sections: [
						{
							...
							commands: [
								{ command: "otter scan", description: "Scan network nodes" },
								{
									command: "otter scan net",
									description: "Network topology scan",
								},
							],
						},
					],
					...
					sections: [
						...
						},
						{
							...
							text: [
								...
								"API Access:",
								"",
								"• Generate key: otter api generate",
								"• View key: otter api show",
								"• Renew key: otter api renew",
							],
						},
						{
