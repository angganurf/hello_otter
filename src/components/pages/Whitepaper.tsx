			...
			<div className="flex flex-col bg-black/80 backdrop-blur-md rounded-lg border border-[#F6BD7A]/30 shadow-lg shadow-[#F6BD7A]/20 h-[600px]">
					...
					<div className="ml-auto flex items-center gap-2">
                       ...
                       border border-[#F6BD7A]/30 hover:border-cyan-400/50 transition-colors"
						>
							...
							<span className="text-[#F6BD7A] font-mono text-[10px] xs:text-xs">
								View PDF
							</span>
						</button>
				...
				<div className="flex-1 p-2 xs:p-3 sm:p-4 overflow-hidden relative pdf-container">
					...
					<iframe
						...
						className="relative w-full h-full rounded-lg border border-[#F6BD7A]/30 
                    bg-black/80 backdrop-blur-md shadow-lg shadow-[#F6BD7A]/20 
