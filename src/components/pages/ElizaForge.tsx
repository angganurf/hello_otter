	...
	return (
		<div className="w-full">
			<div className="flex flex-col lg:flex-row gap-4 max-w-full">
				...
				<div
					className={`${
						isMobile ? "w-full h-[350px] lg:h-[600px]" : "w-1/2 h-[600px]"
					} flex flex-col bg-black/80 backdrop-blur-md rounded-lg border border-[#F6BD7A]/30 shadow-lg shadow-[#F6BD7A]/20`}
				>
					{/* Header */}
					...
					<div className="flex-1 flex flex-col overflow-hidden">
						...
						{/* Input Section */}
						<div className="flex items-center gap-3 p-4 border-t border-[#F6BD7A]/30 bg-black/40">
							<span className="text-cyan-400 font-mono text-base select-none">
								{">"}
							</span>
							<input
								type="text"
								...
								disabled={isLoading}
								className="flex-1 bg-transparent text-[#F6BD7A] outline-none font-mono text-[10px] xs:text-xs sm:text-sm placeholder-[#F6BD7A]/50"
				...
				>
					{/* Preview Header */}
					<div className="flex items-center gap-1.5 xs:gap-2 p-2 xs:p-3 border-b border-[#F6BD7A]/30 bg-black/40">
						<FileJson className="w-3 h-3 xs:w-4 xs:h-4 text-[#F6BD7A]" />
						<span className="text-[#F6BD7A] font-mono text-xs xs:text-sm sm:text-base">
							Character Preview
						</span>
