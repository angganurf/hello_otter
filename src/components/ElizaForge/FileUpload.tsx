...
export const FileUpload: React.FC<FileUploadProps> = ({ onUpload }) => {
	...
	const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		try {
			...
			const baseCharacter = {
				...
				settings: {
					...
					voice: {
						...
						model:
							character.settings?.voice?.model || "en_US-hfc_female-medium",
					},
				},
			};

			// Ensure arrays exist
			baseCharacter.bio = Array.isArray(character.bio)
				? character.bio
				: [character.bio || ""];
			...
			alert(
				"Invalid character file format. Please check the file and try again."
			);
		}
